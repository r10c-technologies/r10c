...
@useCase({
  ...
  labelKey: 'entity:product-category.useCases.retire',
  confirm: {
    tone: 'destructive',
    messageKey: 'entity:product-category.useCases.retireConfirm',
  },
})
export class RetireProductCategoryUC {
  static run() {
 ...
 */
export const RETIRE_PRODUCT_CATEGORY = permissionForUseCase(
