/**
 * The domain name for sales-management.
 *
 ...
 *
 * Entitlement-grantable, unlike `catalog-reference`: a vendor's own selling
 * channels are exactly the kind of thing an organization is provisioned for.
 */
