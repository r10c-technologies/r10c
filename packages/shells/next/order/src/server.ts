// Server-only surface, published as `@r10c/shells-next-order/server`.
//
...
// Where order-service listens. One default, shared by the proxy and the search
// fan-out.
export * from './server/service-urls';

// The order records, as sources the command palette can search (ADR 0040).
