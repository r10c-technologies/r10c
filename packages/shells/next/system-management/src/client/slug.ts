 ...
 * `/system/configuration/new`. Reserving this one literal is the cost of
 * addressing the create form through the same dynamic segment as every record.
 */
...
export function slugToEntityId(slug: string | undefined): EntityId {
  return slug == null || slug === NEW_SLUG ? undefined : slug;
}
