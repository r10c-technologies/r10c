// Server-only surface, published as `@r10c/shells-next-stock/server`.
//
...
// Where stock-service listens. One default, shared by the proxy and the search
// fan-out.
export * from './server/service-urls';

// The stock records, as sources the command palette can search (ADR 0040).
