...
/**
 * Profile selection is by filename, matching the sibling service suites: a spec
 * that cannot run under the active profile is not collected, rather than
