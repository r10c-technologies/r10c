...
/**
 * The user-administration gate. It runs on the server, after the proxy has
 ...
 *
 * Deliberately not in `proxy.ts`: verifying the token there would mean copying
 * the signing key out of config-service into the Next runtime, and this layout
 * needs the principal anyway.
 *
