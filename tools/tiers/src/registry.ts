...
export const PACKAGES: readonly PackageDeclaration[] = [
  ...
  { name: '@r10c/entifix-ts-tooling', dir: 'packages/entifix/ts/tooling', tier: 0 },
  ...
  { name: '@r10c/entifix-ts-business', dir: 'packages/entifix/ts/business', tier: 1 },
  ...
  { name: '@r10c/entifix-ts-mongo-client', dir: 'packages/entifix/ts/mongo-client', tier: 2 },
  { name: '@r10c/entifix-ts-sql-client', dir: 'packages/entifix/ts/sql-client', tier: 2 },
  { name: '@r10c/entifix-ts-redis-client', dir: 'packages/entifix/ts/redis-client', tier: 2 },
  { name: '@r10c/entifix-ts-amqp-client', dir: 'packages/entifix/ts/amqp-client', tier: 2 },
  { name: '@r10c/entifix-ts-rest-client', dir: 'packages/entifix/ts/rest-client', tier: 2 },
  { name: '@r10c/entifix-transactions', dir: 'packages/entifix/ts/transactions', tier: 2 },
  { name: '@r10c/entifix-ts-jwt-client', dir: 'packages/entifix/ts/jwt-client', tier: 2 },
  { name: '@r10c/entifix-ts-zitadel-client', dir: 'packages/entifix/ts/zitadel-client', tier: 2 },
  { name: '@r10c/entifix-ts-posthog-client', dir: 'packages/entifix/ts/posthog-client', tier: 2 },

  // T3 — the agnostic UI. Adoptable without T0: a table must not arrive with
  // i18next and a Spanish catalog attached.
  { name: '@r10c/entifix-react-controls', dir: 'packages/entifix/react/controls', tier: 3 },
  { name: '@r10c/entifix-react-integration', dir: 'packages/entifix/react/integration', tier: 3 },

  // T4 — the application framework: the authorization vocabulary and the two
  // shells that serve and render an entity.
  { name: '@r10c/business-ts-authz', dir: 'packages/business/ts/authz', tier: 4 },
  { name: '@r10c/shells-effect-service', dir: 'packages/entifix/effect/service-shell', tier: 4 },
  { name: '@r10c/shells-next-common', dir: 'packages/entifix/next/shell', tier: 4 },
  { name: '@r10c/shells-next-i18n', dir: 'packages/entifix/next/i18n', tier: 4 },

  // T5 — testing. Above everything because a double may impersonate anything.
  { name: '@r10c/entifix-ts-testing-unit', dir: 'packages/entifix/ts/testing-unit', tier: 5 },
  { name: '@r10c/entifix-ts-testing-e2e', dir: 'packages/entifix/ts/testing-e2e', tier: 5 },
];
